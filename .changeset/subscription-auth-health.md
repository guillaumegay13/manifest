...
Also fixes the self-hosted recording path writing to `/data/request-recordings/request-recordings/...` (the `request-recordings/` key namespace was being appended to a root that already ended in the same segment).
