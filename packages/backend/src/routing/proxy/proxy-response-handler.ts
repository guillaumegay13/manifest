...
export async function handleStreamResponse(
  ...
  // (issues #1900 and #2064). It shares the messages transformer's
  // {transform, finalize} shape, and likewise owns stream termination via
  // `finalize` (which emits the trailing `[DONE]` that pipeStream then skips).
